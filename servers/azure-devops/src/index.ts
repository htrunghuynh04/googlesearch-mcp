...
async function main() {
  try {
    ...
    allowedTools.has('getWikiPageById') &&
      server.tool(
        'getWikiPageById',
    ...
    allowedTools.has('getWikiPageDetails') &&
      server.tool(
        'getWikiPageDetails',
